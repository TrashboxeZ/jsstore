        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php if($query = mysqli_query($link,"SELECT count(id) FROM products")): ?>
                    <?php $count = mysqli_fetch_row($query);
                        ///колво страниц
                        $count = $count[0];
...
//                        echo $total;
                ...
                //       var_dump($page);
                    ...
                    ?>
                                ...
                                <li><a class='page-link' href='#<?php echo $left; ?>' data-id='<?php echo $left ?>'>PREV</a></li>
                                <?php for($i = 1; $i <= $total; $i++): ?>
                                <li>
                                    <a class='page-link' href='#<?php echo $i; ?>' data-id='<?php echo $i ?>'>
                                        <?php echo $i; ?>
                                    </a>
                                </li>
                                ...
                                <?php endfor ?>
                                <li><a class='page-link' href='#<?php echo $right; ?>' data-id='<?php echo $right ?>'>NEXT</a></li>
                                <?php endif ?>
                                <?php endif ?>
